...
def parse_args():
    ...
    trainingArgs.add_argument("--weight_decay", type=float, default=0.0, help="weight_decay rate")
    ...
    trainingArgs.add_argument("--temperature", type=float, default=1.0, help="gumbel softmax temperature")
